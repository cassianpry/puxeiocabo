...
# Implement frontend route pages Plan

> Wire up all route pages with real data from backend APIs
...
- **Total symbols discovered:** 288
- **Architecture layers:** Config, Controllers, Services, Utils, Models, Components
- **Detected patterns:** Service Layer, Controller
- **Entry points:** scraper/src/index.ts, backend/src/main.ts, scraper/src/validator/index.ts (+7 more)

### Key Components
**Core Classes:**
- `AppService` — /run/media/cass/dev/Development/puxeiocabo/backend/src/app.service.ts:4
- `AppModule` — /run/media/cass/dev/Development/puxeiocabo/backend/src/app.module.ts:14
- `AppController` — /run/media/cass/dev/Development/puxeiocabo/backend/src/app.controller.ts:5
- `Sf6Scraper` — /run/media/cass/dev/Development/puxeiocabo/scraper/src/scraper/index.ts:5
- `ReportService` — /run/media/cass/dev/Development/puxeiocabo/backend/src/report/report.service.ts:20

**Key Interfaces:**
- `FileRoutesByFullPath` — /run/media/cass/dev/Development/puxeiocabo/frontend/src/routeTree.gen.ts:90
- `FileRoutesByTo` — /run/media/cass/dev/Development/puxeiocabo/frontend/src/routeTree.gen.ts:103
- `FileRoutesById` — /run/media/cass/dev/Development/puxeiocabo/frontend/src/routeTree.gen.ts:116
- `FileRouteTypes` — /run/media/cass/dev/Development/puxeiocabo/frontend/src/routeTree.gen.ts:132
- `RootRouteChildren` — /run/media/cass/dev/Development/puxeiocabo/frontend/src/routeTree.gen.ts:176
## Agent Lineup
